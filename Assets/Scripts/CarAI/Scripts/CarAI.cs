...
public class CarAI : MonoBehaviour
{
    ...
    void ApplySteering() // Applies steering to the Current waypoint
    {
        ...
        if (aracindex == 0)
        {
            ...
            else if (AracBilgleri.durum[0] == 1)
            {
                MaxRPM = 0;
                if (SteeringAngle > 15) LocalMaxSpeed = 0;
                else LocalMaxSpeed = MaxRPM;
                frontLeft.steerAngle = SteeringAngle;
                frontRight.steerAngle = SteeringAngle;
            }
        ...
        else if (aracindex == 4)
        {
            ...
            else if(AracBilgleri.durum[2] == 1)
            {
                MaxRPM = 0;
                if (SteeringAngle > 15) LocalMaxSpeed = 0;
                else LocalMaxSpeed = MaxRPM;
        ...
        else if (aracindex == 1)
        {
            ...
            else if (AracBilgleri.durum[1] == 1)
            {
                MaxRPM = 0;
                if (SteeringAngle > 15) LocalMaxSpeed = 0;
                else LocalMaxSpeed = MaxRPM;
        ...
        else if (aracindex == 3)
        {
            ...
            else if (AracBilgleri.durum[3] == 1)
            {
                MaxRPM = 0;
                if (SteeringAngle > 15) LocalMaxSpeed = 0;
                else LocalMaxSpeed = MaxRPM;
        ...
        else if (aracindex == 2)
        {
            ...
            else if (AracBilgleri.durum[4] == 2)
            {
                MaxRPM = 100;
                if (SteeringAngle > 15) LocalMaxSpeed = 100;
                else LocalMaxSpeed = MaxRPM;
        ...
        else if (aracindex == 5)
        {
            ...
            else if (AracBilgleri.durum[5] == 1)
            {
                MaxRPM = 0;
                if (SteeringAngle > 15) LocalMaxSpeed = 0;
                else LocalMaxSpeed = MaxRPM;
        ...
        else if (aracindex == 6)
        {
            ...
            else if (AracBilgleri.durum[6] == 1)
            {
                MaxRPM = 0;
                if (SteeringAngle > 15) LocalMaxSpeed = 0;
                else LocalMaxSpeed = MaxRPM;
        ...
        else if (aracindex == 7)
        {
            ...
            else if (AracBilgleri.durum[7] == 1)
            {
                MaxRPM = 0;
                if (SteeringAngle > 15) LocalMaxSpeed = 0;
                else LocalMaxSpeed = MaxRPM;
        ...
        else if (aracindex == 8)
        {
            ...
            else if (AracBilgleri.durum[8] == 1)
            {
                MaxRPM = 0;
                if (SteeringAngle > 15) LocalMaxSpeed = 0;
                else LocalMaxSpeed = MaxRPM;
        ...
        else if (aracindex == 9)
        {
            ...
            else if (AracBilgleri.durum[9] == 1)
            {
                MaxRPM = 0;
                if (SteeringAngle > 15) LocalMaxSpeed = 0;
                else LocalMaxSpeed = MaxRPM;
        ...
        else if (aracindex == 10)
        {
            ...
            else if (AracBilgleri.durum[10] == 1)
            {
                MaxRPM = 0;
                if (SteeringAngle > 15) LocalMaxSpeed = 0;
                else LocalMaxSpeed = MaxRPM;
        ...
        else if (aracindex == 11)
        {
            ...
            else if (AracBilgleri.durum[11] == 1)
            {
                MaxRPM = 0;
                if (SteeringAngle > 15) LocalMaxSpeed = 0;
                else LocalMaxSpeed = MaxRPM;
        ...
        else if (aracindex == 12)
        {
            ...
            else if (AracBilgleri.durum[12] == 1)
            {
                MaxRPM = 0;
                if (SteeringAngle > 15) LocalMaxSpeed = 0;
                else LocalMaxSpeed = MaxRPM;
        ...
        else if (aracindex == 13)
        {
            ...
            else if (AracBilgleri.durum[13] == 1)
            {
                MaxRPM = 0;
                if (SteeringAngle > 15) LocalMaxSpeed = 0;
                else LocalMaxSpeed = MaxRPM;
        ...
        else if (aracindex == 14)
        {
            ...
            else if (AracBilgleri.durum[14] == 1)
            {
                MaxRPM = 0;
                if (SteeringAngle > 15) LocalMaxSpeed = 0;
                else LocalMaxSpeed = MaxRPM;
        ...
        else if (aracindex == 15)
        {
            ...
            else if (AracBilgleri.durum[15] == 1)
            {
                MaxRPM = 0;
                if (SteeringAngle > 15) LocalMaxSpeed = 0;
                else LocalMaxSpeed = MaxRPM;
        ...
        else if (aracindex == 16)
        {
            ...
            else if (AracBilgleri.durum[16] == 1)
            {
                MaxRPM = 0;
                if (SteeringAngle > 15) LocalMaxSpeed = 0;
                else LocalMaxSpeed = MaxRPM;
        ...
        else if (aracindex == 17)
        {
            ...
            else if (AracBilgleri.durum[17] == 1)
            {
                MaxRPM = 0;
                if (SteeringAngle > 15) LocalMaxSpeed = 0;
                else LocalMaxSpeed = MaxRPM;
